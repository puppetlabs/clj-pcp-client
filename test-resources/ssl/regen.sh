...
declare -a client_array=(client01.example.com client02.example.com client03.example.com controller01.example.com controller02.example.com controller03.example.com localhost)
